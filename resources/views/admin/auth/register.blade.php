...
<head>
    ...
    <style>
        body {
            background-color: #e6e165 !important;
        }
    </style>
</head>
<!--end::Head-->
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                ...
                <div class="d-flex flex-center flex-lg-start flex-column">
                    ...
                    <a href="{{ url('/') }}" class="mb-7">
                        <img alt="Logo" src="{{ asset('logo2.png') }}" width="400px" />
                    </a>
            ...
            <div
                ...
                <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                        <!--begin::Form-->
                        <form method="POST" action="/register" class="form w-100" novalidate="novalidate"
                            id="formInput" name="formInput">
                            @csrf

                            <!--begin::Heading-->
                            <div class="text-center mb-11">
                                <!--begin::Title-->
                                <h1 class="text-dark fw-bolder mb-3">Halaman Register</h1>
                                <!--end::Title-->
                                <!--begin::Subtitle-->
