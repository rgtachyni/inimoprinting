                                    ...
                                    <div class="c-content-overlay">
                                        ...
                                        <div class="c-bg-img-top-center c-overlay-object" data-height="height">
                                            <img width="100%" class="img-responsive"
                                                src="../../assets/base/img/content/shop2/24.jpg">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-8">
                                    <ul class="c-list list-unstyled">
                                        <li class="c-margin-b-25"><a href="shop-product-details-2.html"
                                                class="c-font-bold c-font-22 c-theme-link">Winter Coat</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-12 c-image">
                                    <div class="c-content-overlay">
                                        ...
                                        <div class="c-bg-img-top-center c-overlay-object" data-height="height">
                                            <img width="100%" class="img-responsive"
                                                src="../../assets/base/img/content/shop2/12.jpg">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-5 col-sm-8">
                                    <ul class="c-list list-unstyled">
                                        <li class="c-margin-b-25"><a href="shop-product-details-2.html"
                                                class="c-font-bold c-font-22 c-theme-link">Sports Wear</a></li>
                                        <li class="c-margin-b-10">Color: Blue</li>
                                        <li>Size: S</li>
                                        <li>Quantity: x1</li>
                                    </ul>
                        ...
                        <div class="col-md-6 col-sm-6 c-margin-t-20">
                            <div data-height="height">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>Email: <a href="mailto:info@jango.com" class="c-theme-color">info@jango.com</a>
                                    </li>
