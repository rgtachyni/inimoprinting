                    ...
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                            ...
                            <div class="tp-caption customin customout" data-x="center" data-y="center" data-hoffset=""
                                ...
                                <h3
                                    ...
                                    LET'S SHOP AT<br>INIMO PRINTING
                                </h3>
                            </div>
                        ...
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="1000">
                            ...
                            <div class="tp-caption customin customout" data-x="center" data-y="center" data-hoffset=""
                                ...
                                <h3
                                    class="c-main-title-circle c-font-48 c-font-bold c-font-center c-font-uppercase c-font-white c-block">
                                    INIMO PRINTING <br> IS HIGH QUALITY PRINTS
                                </h3>
                            </div>
                            <div class="tp-caption lft" data-x="center" data-y="center" data-voffset="110" data-speed="900"
                                data-start="2000" data-transform_idle="o:1;"
                                    ...
                                    <div class="panel">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                            ...
                                            <div class="panel-body c-font-18">
                                                Inimo Printing melayani order minimal 1 pcs untuk beberapa produk,
                                                memudahkan Anda yang butuh cetak dalam jumlah kecil. Sistem order online 24
                                                jam memungkinkan Anda memesan kapan saja, dengan berbagai metode pembayaran
                                                (transfer, COD, atau e-wallet).
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="panel-body c-font-18">
                                                    Jaringan logistik kami mencakup seluruh Indonesia, dengan kemasan khusus
                                                    yang melindungi produk dari kerusakan selama pengiriman.
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                                aria-labelledby="headingThree">
                                                <div class="panel-body c-font-18">
                                                    Kami memilih bahan-bahan berkualitas tinggi, baik lokal maupun impor,
                                                    yang tahan air, UV, dan tidak mudah luntur. Setiap detail diperhatikan
                                                    dengan cermat untuk memastikan hasil akhir yang memuaskan, baik untuk
                                                    cetak kecil seperti kartu nama maupun proyek besar seperti banner dan
                                                    spanduk.
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane fade in active" id="c-tab2-opt1-1">
                                                    <div class="c-tab-pane">
                                                        ...
                                                        <p class="c-font-17 c-margin-b-20 c-margin-t-20 c-font-thin ">
                                                            Inimo Printing menggunakan bahan dan tinta berkualitas tinggi,
                                                            serta
                                                ...
                                                <div class="tab-pane fade" id="c-tab2-opt1-2">
                                                    <div class="c-tab-pane">
                                                        ...
                                                        <p class="c-font-17 c-margin-b-20 c-margin-t-20 c-font-thin ">
                                                            ...
                                                            menjamin pesanan selesai dan dikirim tepat waktu sesuai
                                                            kesepakatan.
                ...
                <div class="container">
                    <div class="c-content-blog-post-card-1-slider" data-slider="owl">
                        <div class="c-content-title-1">
                            ...
                            <div class="c-line-center c-theme-bg"></div>
                            {{-- <p class="c-center c-font-uppercase1">Lorem ipsum dolor sit amet et consectetuer adipiscing
                                elit
                            </p> --}}
                        </div>
                        <div class="owl-carousel owl-theme c-theme c-owl-nav-center" data-items="3"
                            data-slide-speed="8000" data-rtl="false">
                            <div class="item">
                                <div class="c-content-testimonial-3 c-option-default">
                                    <div class="c-content">
                                        Hasil cetak brosur perusahaan saya sangat memuaskan! Warna tajam dan kertasnya
                                        premium.Bakal order lagi!"
                                    </div>
                                    <div class="c-person">
                                        <img src="{{ asset('tampilanUser/user.png') }}" class="img-responsive">
                                        <i class="bi bi-person-fill"></i>
                                        <div class="c-person-detail c-font-uppercase">
                                            <h4 class="c-name">Bpk. Andi</h4>
                                            <p class="c-position c-font-bold c-theme-font">Pemilik UMKM Kuliner</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="c-content-testimonial-3 c-option-default">
                                    <div class="c-content">
                                        Cetak 1000 stiker buat event kampus, harganya ternyata lebih murah dr tempat lain.
                                        Pengirimannya tepat waktu dan packingnya rapi banget. Recommended!
                                    </div>
                                    <div class="c-person">
                                        <img src="{{ asset('tampilanUser/user.png') }}" class="img-responsive">
                                        <div class="c-person-detail c-font-uppercase">
                                            <h4 class="c-name">Sdr. Akaml</h4>
                                            <p class="c-position c-font-bold c-theme-font">Mahasiswa Organisasi</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="c-content-testimonial-3 c-option-default">
                                    <div class="c-content">
                                        Pertama kali pesan sticker custom, hasilnya presisi banget! Tahan hujan & cuaca
                                        panas. Pelayanannya ramah & fast respon. Puas!
                                    </div>
                                    <div class="c-person">
                                        <img src="{{ asset('tampilanUser/user.png') }}" class="img-responsive">
                                        <div class="c-person-detail c-font-uppercase">
                                            <h4 class="c-name">Ibu Lily</h4>
                                            <p class="c-position c-font-bold c-theme-font">Pemilik bisnis online</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="c-content-testimonial-3 c-option-default">
                                    <div class="c-content">
                                        Order kartu nama urgent buat meeting besok, pagi pesan sore sudah sampai!
                                        Kualitasnya premium & desain sesuai permintaan. Terima kasih Inimo!
                                    </div>
                                    <div class="c-person">
                                        <img src="{{ asset('tampilanUser/user.png') }}" class="img-responsive">
                                        <div class="c-person-detail c-font-uppercase">
                                            <h4 class="c-name">Bpk. Ooka</h4>
                                            <p class="c-position c-font-bold c-theme-font">Sales</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="c-content-testimonial-3 c-option-default">
                                    <div class="c-content">
                                        Cetak banner 3x5 meter buat promo toko, warnanya hidup & teksnya jelas terbaca.
                                        Bahannya tebal dan tahan angin. Next order pasti kesini lagi!
                                    </div>
                                    <div class="c-person">
                                        <img src="{{ asset('tampilanUser/user.png') }}" class="img-responsive">
                                        <div class="c-person-detail c-font-uppercase">
                                            <h4 class="c-name">Sdri. Putri</h4>
                                            <p class="c-position c-font-bold c-theme-font">Pemilik toko</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
